<?php /*a:5:{s:61:"C:\phpstudy_pro\WWW\WWW\application\admin\view\card\list.html";i:1574859673;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\head.html";i:1572934894;s:62:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\top.html";i:1572768546;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\left.html";i:1574513257;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\foot.html";i:1572934632;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="page-sidebar" id="sidebar">
    ...
    <!-- /页面侧栏 -->
            ...
            <div class="page-content">
                ...
                <!-- 页面内容 -->
                <div class="page-body">
                        <form action="<?php echo url('admin/card/delall'); ?>" method="post">
                        <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon"
                            onClick="javascript:window.location.href = '<?php echo url('admin/card/add'); ?>'"> <i class="fa fa-plus"></i>
                            添加卡密
                        </button>
                        <button type="submit" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="odd">
                                                        <td class=" ">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" value="<?php echo htmlentities($l['id']); ?>" id="check" name="cardid[]">
                                                        ...
                                                        <td class="center  ">
                                                            <font style="vertical-align: inherit;">
                                                                <font style="vertical-align: inherit;">
                                                                <?php echo htmlentities($l['goodname']); ?>                                                                    
                                                                </font>
                                                            </font>
                                                        </td>
                                                        <td class="center  ">
                                                        ...
                                                        <td class="center  ">
                                                            <font style="vertical-align: inherit;">
                                                                <font style="vertical-align: inherit;">
                                                                <?php echo htmlentities(date('m-d H:i:s',!is_numeric($l['addtime'])? strtotime($l['addtime']) : $l['addtime'])); ?>                                                                   
                                                                </font>
                                                            </font>
                                                        </td>
                                                        <td class="center  ">
                                                        ...
                                                        <td class="center  ">
                                                            <font style="vertical-align: inherit;">
                                                                <font style="vertical-align: inherit;">
                                                                <?php if(($l['order'] != '' )): ?><?php echo htmlentities($l['order']); else: ?>未售出无订单号
                                                                <?php endif; ?>                                                                  
                                                                </font>
                                                            </font>
                                                        </td>
                                                        <td class=" ">
                                                            ...
                                                            <a href="<?php echo url('admin/card/del',['id'=>$l['id']]); ?>" 
