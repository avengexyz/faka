<?php /*a:5:{s:61:"C:\phpstudy_pro\WWW\WWW\application\admin\view\type\edit.html";i:1574686038;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\head.html";i:1572934894;s:62:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\top.html";i:1572768546;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\left.html";i:1574513257;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\foot.html";i:1572934632;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo url('admin/type/list'); ?>">商品分类管理</a>
                            </li>
                                        ...
                                        <div id="horizontal-form">
                                            <form class="form-horizontal" role="form" action="" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="username"
                                                        class="col-sm-2 control-label no-padding-right">商品分类名</label>
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="username" placeholder=""
                                                            name="typename" required="" type="text" value="<?php echo htmlentities($list['typename']); ?>">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <button type="submit" class="btn btn-default">添加商品分类</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
