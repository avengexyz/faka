<?php /*a:1:{s:68:"C:\phpstudy_pro\WWW\WWW\application\index\view\index\tem1\index.html";i:1574879256;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
...
<body>
    ...
    <div id="pay">
        <div id="paysel">
            <h6>支付方式</h6>
            <ul>
                <?php if(is_array($pay) || $pay instanceof \think\Collection || $pay instanceof \think\Paginator): $i = 0; $__LIST__ = $pay;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pay): $mod = ($i % 2 );++$i;if(($pay['id']==1)): ?>
                <li>
                ...
                <li>
                    ...
                    <img src="/static/index//img/weixin.gif" alt="">
                </li>
                <?php else: ?>
                <?php endif; ?>
                <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div id="footer">
        <div id="footerbar">
            <h6><?php echo htmlentities($conf['info']); ?></h6>
        </div>
    </div>
