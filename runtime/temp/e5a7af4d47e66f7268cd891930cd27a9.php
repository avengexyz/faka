<?php /*a:5:{s:62:"C:\phpstudy_pro\WWW\WWW\application\admin\view\admin\list.html";i:1572716226;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\head.html";i:1572934894;s:62:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\top.html";i:1572768546;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\left.html";i:1574513257;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\foot.html";i:1572934632;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('admin/admin/add'); ?>'"> <i class="fa fa-plus"></i>
                        添加管理员
                    </button>
                    <div class="row">
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class=" ">
                                                        <a href="<?php echo url('admin/admin/edit',['id'=>$l['id']]); ?>" class="btn btn-info btn-xs edit"><i
                                                                class="fa fa-edit"></i>
                                                            <font style="vertical-align: inherit;">
                                                                <font style="vertical-align: inherit;"> 编辑</font>
                                                            </font>
                                                        </a>
                                                        <a href="<?php echo url('admin/admin/del',['id'=>$l['id']]); ?>" 
