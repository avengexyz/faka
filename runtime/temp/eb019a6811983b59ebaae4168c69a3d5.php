<?php /*a:5:{s:62:"C:\phpstudy_pro\WWW\WWW\application\admin\view\goods\edit.html";i:1574859367;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\head.html";i:1572934894;s:62:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\top.html";i:1572768546;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\left.html";i:1574513257;s:63:"C:\phpstudy_pro\WWW\WWW\application\admin\view\common\foot.html";i:1572934632;}*/ ?>
<!DOCTYPE html>
<html>
                                        ...
                                        <div id="horizontal-form">
                                            <form class="form-horizontal" role="form" action="" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="username" placeholder=""
                                                            name="goodname" required="" type="text" value="<?php echo htmlentities($list['goodname']); ?>">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <textarea name="gooddesc" id="" cols="30" rows="10" class="form-control"><?php echo htmlentities($list['gooddesc']); ?></textarea>
                                                    </div>
                                                    <p class="help-block col-sm-4 red">* 必填</p>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="username" placeholder=""
                                                            name="goodprice" required="" type="text" value="<?php echo htmlentities($list['goodprice']); ?>">
                                                    </div>
                                                    <p class="help-block col-sm-4 red">* 必填</p>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name="typeid" id="">
                                                            ...
                                                            <option <?php if(($list['typeid']==$type['id'])): ?>selected<?php endif; ?> value="<?php echo htmlentities($type['id']); ?>"><?php echo htmlentities($type['typename']); ?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="username" placeholder=""
                                                            name="goodcount" required="" type="text" value="<?php echo htmlentities($list['goodcount']); ?>">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name="goodship" id="">
                                                            <option <?php if(($list['goodship']==0)): ?>selected<?php endif; ?> value="0">自动发货</option>
                                                            <option <?php if(($list['goodship']==1)): ?>selected<?php endif; ?> value="1">手动发货</option>
                                                        </select>
                                                    </div>
                                                    <p class="help-block col-sm-4 red">* 必填</p>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name="goodstatus" id="">
                                                            <option <?php if(($list['goodstatus']==0)): ?>selected<?php endif; ?> value="0">下架</option>
                                                            <option <?php if(($list['goodstatus']==1)): ?>selected<?php endif; ?> value="1">上架</option>
                                                        </select>
                                                    </div>
                                                    <p class="help-block col-sm-4 red">* 必填</p>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <button type="submit" class="btn btn-default">编辑商品</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
